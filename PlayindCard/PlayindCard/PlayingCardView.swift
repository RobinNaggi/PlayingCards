...
@IBDesignable class PlayingCardView: UIView {
    ...
    @objc func adjustFaceCardScale(byHandlingGestureReconnizerBy recognizer: UIPinchGestureRecognizer) {
...
// extends PlayingCardView to provide constants and computed vars
// for drawing card and positioning and drawing labels
...
extension PlayingCardView {
    ...
    // function to draw pips for different values
